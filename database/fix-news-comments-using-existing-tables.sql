-- K-매거진 뉴스 댓글 시스템 수정 (기존 posts/comments 테이블 사용)
-- Fix K-Magazine News Comment System (Using Existing posts/comments Tables)
-- 생성일: 2025-10-07
...
-- ============================================
-- 3. posts 테이블에 comment_count 컬럼 추가
-- ============================================
...
BEGIN
    ...
    RAISE NOTICE '1. 기존 posts/comments/reactions 테이블을 사용합니다.';
