...
-- ============================================================
-- PARTE 0 — Drop constraint + migrar datos + re-crear constraint
-- ============================================================

-- 0.1 Primero eliminamos el constraint para poder actualizar los datos
ALTER TABLE education_courses
  DROP CONSTRAINT IF EXISTS education_courses_status_check;

-- 0.2 Migrar cursos con estado legacy 'pending_review' → 'submitted_for_review'
...
-- ============================================================
-- PARTE 1 — Ampliar estados de las demás tablas (DROP CONSTRAINT + ADD)
-- ============================================================

-- (education_courses ya fue manejada en PARTE 0)
