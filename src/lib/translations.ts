...
export const translations = {
  ko: {
    ...
    payments: {
      title: '결제',
      subtitle: '원하는 서비스를 선택하여 결제하세요',
      couponSystem: '쿠폰 시스템',
      vipSubscription: 'VIP 구독',
      courses: '강의',
      paymentHistory: '결제 내역',
      paymentHistoryEmpty: '결제 내역이 없습니다',
      viewFullHistory: '전체 내역 보기',
      loginRequired: '로그인이 필요합니다',
      loginRequiredDescription: '결제를 진행하려면 먼저 로그인해주세요',
      selectOption: '옵션 선택',
      selectCoupon: '쿠폰 선택',
      selectVip: 'VIP 플랜 선택',
      selectCourse: '강의 선택',
      coupon20min: '20분 쿠폰',
      coupon20minDesc: '20분 화상 통화 쿠폰',
      coupon100min: '100분 쿠폰',
      coupon100minDesc: '100분 화상 통화 쿠폰',
      coupon200min: '200분 쿠폰',
      coupon200minDesc: '200분 화상 통화 쿠폰',
      coupon400min: '400분 쿠폰',
      coupon400minDesc: '400분 화상 통화 쿠폰',
      vipMonthly: 'VIP 월간',
      vipMonthlyDesc: '월간 VIP 구독 (30일)',
      vipYearly: 'VIP 연간',
      vipYearlyDesc: '연간 VIP 구독 (365일)',
      vipLifetime: 'VIP 평생',
      vipLifetimeDesc: '평생 VIP 구독',
      course1: '한국 문화 기초',
      course1Desc: '한국 문화 기초 강의 (최대 10명)',
      course2: '고급 한국어',
      course2Desc: '고급 한국어 실력 향상 (최대 8명)',
      course3: 'K-Pop & 엔터테인먼트',
      course3Desc: 'K-Pop과 엔터테인먼트 문화 (최대 12명)',
      statusPaid: '완료',
      statusPending: '처리중',
      minuteCoupon: '분 쿠폰',
      koreanCultureBasic: '한국 문화 기초 강의',
      // Payment Success Page
      processingPayment: '결제를 처리하고 있습니다...',
      pleaseWait: '잠시만 기다려주세요',
      paymentFailed: '결제 처리 실패',
      paymentFailedDescription: '결제 처리에 실패했습니다. 관리자에게 문의하거나 다시 시도해주세요.',
      tryAgain: '다시 시도',
      paymentCompleted: '결제가 완료되었습니다!',
      bookingConfirmed: '상담 예약이 성공적으로 확정되었습니다.',
      paymentInfo: '결제 정보',
      orderNumber: '주문 번호:',
      paymentAmount: '결제 금액:',
      bookingInfo: '예약 정보',
      bookingProcessing: '예약 정보 처리 중',
      bookingProcessingDescription: '예약 정보를 불러오는 중입니다. 웹훅 처리 후 자동으로 업데이트됩니다.',
      paymentCompletedBadge: '결제 완료',
      reminderMessage: '상담 시작 1시간 전에 알림을 보내드립니다.',
      contactMessage: '상담 관련 문의사항이 있으시면 언제든 연락주세요.',
      paypalNote: '💡 결제 처리는 PayPal로 완료되었습니다.',
      viewBookings: '예약 목록 보기',
      backToHome: '홈으로 돌아가기',
      consultant: '상담사:',
      bookingDateTime: '상담 일시:',
      bookingDuration: '상담 시간:',
      bookingTopic: '상담 주제:',
      reminderNotification: '상담 시작 1시간 전에 알림을 보내드립니다.',
      contactSupport: '상담 관련 문의사항이 있으시면 언제든 연락주세요.',
    ...
    payments: {
      ...
      // Sistema de Cupones
      coupon20min: '쿠폰 시스템 - 20분',
      coupon20minDesc: '20분 화상채팅 쿠폰',
      coupon100min: '쿠폰 시스템 - 100분',
      coupon100minDesc: '100분 화상채팅 쿠폰',
      coupon200min: '쿠폰 시스템 - 200분',
      coupon200minDesc: '200분 화상채팅 쿠폰',
      coupon400min: '쿠폰 시스템 - 400분',
      coupon400minDesc: '400분 화상채팅 쿠폰',
      // VIP Subscription
      vipMonthly: 'VIP 월간 구독',
      vipMonthlyDesc: '월간 VIP 혜택',
      vipYearly: 'VIP 연간 구독',
      vipYearlyDesc: '연간 VIP 혜택',
      vipLifetime: 'VIP 평생 구독',
      vipLifetimeDesc: '평생 VIP 혜택',
      // Courses
      course1: '강의 1 - 한국 문화 기초',
      course1Desc: '한국 문화와 언어의 기초를 배우는 종합 강의',
      course2: '강의 2 - 고급 한국어 실력 향상',
      course2Desc: '한국어 실력을 한 단계 높이는 고급 강의',
      course3: '강의 3 - K-Pop & 엔터테인먼트 문화',
      course3Desc: 'K-Pop 산업과 한국 엔터테인먼트 문화를 탐구',
      // Section Headers
      couponSystem: '쿠폰 시스템',
      vipSubscription: 'VIP 구독',
      courses: '강의',
    ...
    auth: {
      ...
      resetPassword: {
        ...
        passwordRequirements: '비밀번호 요구사항을 충족하지 않습니다',
      ...
      loginIdInfo: '💡 로그인 아이디는 가입 시 입력한 이메일 또는 전화번호입니다',
      password: '비밀번호',
      ...
      emailLoginIdInfo: '이메일은 로그인 아이디로 사용됩니다',
      phone: '전화번호',
      phoneLoginIdInfo: '전화번호는 로그인 아이디로 사용됩니다',
      country: '국가',
      countryCode: '국가 코드',
      ...
      signUpSuccess: '회원가입이 완료되었습니다! 로그인 아이디는 이메일입니다.',
      signUpFailed: '회원가입에 실패했습니다',
      signUpError: '회원가입 중 오류가 발생했습니다',
      alreadyHaveAccount: '이미 계정이 있으신가요?',
      noAccount: '계정이 없으신가요?',
      credentialsCheckMessage: '이메일과 비밀번호를 확인해주세요',
      verifying: '인증 확인 중...',
      pleaseWait: '잠시만 기다려주세요.',
      ...
      verificationCodeSendFailed: '인증코드 발송에 실패했습니다.',
      emailVerificationCodeSendFailed: '이메일 인증코드 발송에 실패했습니다.',
      smsVerificationCodeSendFailed: 'SMS 인증코드 발송에 실패했습니다.',
      whatsappVerificationCodeSendFailed: 'WhatsApp 인증코드 발송에 실패했습니다.',
      verificationCodeIncorrect: '인증코드가 올바르지 않습니다.',
      signUpSuccess: '회원가입이 완료되었습니다! 로그인 아이디는 이메일입니다.',
      signUpError: '회원가입 중 오류가 발생했습니다.',
      emailAlreadyExists: '이미 가입된 이메일입니다. 다른 이메일을 사용하거나 로그인해주세요.',
      phoneAlreadyExists: '이미 가입된 전화번호입니다. 다른 전화번호를 사용하거나 로그인해주세요.',
      checkError: '확인 중 오류가 발생했습니다.',
      systemMaintenance: '시스템 점검 중입니다. 잠시 후 다시 시도해주세요.',
      loginRequired: '로그인이 필요합니다.',
      titleAndContentRequired: '제목과 내용을 모두 입력해주세요.',
      announcementCreated: '공지사항이 작성되었습니다.',
      announcementCreateFailed: '공지사항 작성에 실패했습니다.',
      imageUploadFailed: '이미지 업로드에 실패했습니다.',
      postDeleted: '게시글이 삭제되었습니다.',
      postDeleteFailed: '게시글 삭제에 실패했습니다.',
      postDeleteError: '게시글 삭제 중 오류가 발생했습니다.',
      postCreated: '게시글이 작성되었습니다!',
      postCreateFailed: '게시글 작성에 실패했습니다.',
      postCreateError: '게시글 작성 중 오류가 발생했습니다.',
      questionCreated: '질문이 등록되었습니다!',
      questionCreateFailed: '질문 작성에 실패했습니다.',
      ...
      pointLimitExceeded: '오늘 포인트 한도를 초과했습니다.',
      imageFileOnly: '이미지 파일만 업로드할 수 있습니다.',
      fileSizeExceeded: '파일 크기가 5MB를 초과합니다.',
      maxImagesExceeded: '최대 5개까지 이미지를 업로드할 수 있습니다.',
      confirmDelete: '정말로 삭제하시겠습니까?',
      confirmDeletePost: '정말로 이 게시글을 삭제하시겠습니까?',
      confirmDeleteNews: '정말로 이 뉴스를 삭제하시겠습니까?',
    ...
    communityTab: {
      ...
      cleanExpiredStories: '만료된 스토리 정리',
      noUploadedStories: '아직 업로드한 스토리가 없습니다.',
      uploadFirstStoryPrompt: '첫 번째 스토리를 업로드해보세요!',
      loadingStories: '스토리를 불러오는 중...',
      cleanupFailed: '만료된 스토리 정리에 실패했습니다.',
      cleanupError: '스토리 정리 중 오류가 발생했습니다.',
      cleanupSuccess: '{count}개의 만료된 스토리가 삭제되었습니다.',
    ...
    community: {
      ...
      chatRoomNoRooms: '아직 채팅방이 없습니다',
      chatRoomName: '채팅방 이름',
      chatRoomNamePlaceholder: '예: K-POP 토론방',
      chatRoomDescription: '설명',
      chatRoomDescriptionPlaceholder: '채팅방에 대한 간단한 설명을 입력하세요',
      chatRoomThumbnail: '채팅방 이미지',
      chatRoomClickToUpload: '클릭하여 이미지 업로드',
      chatRoomImageFormat: 'PNG, JPG, GIF (최대 5MB)',
      chatRoomImageOnly: '이미지 파일만 업로드 가능합니다.',
      chatRoomImageSize: '파일 크기는 5MB를 초과할 수 없습니다.',
      chatRoomUploading: '업로드 중...',
      chatRoomCancel: '취소',
      chatRoomCreating: '생성 중...',
      chatRoomCreated: '채팅방이 생성되었습니다!',
      chatRoomCreateFailed: '채팅방 생성에 실패했습니다.',
      chatRoomCreateError: '채팅방 생성 중 오류가 발생했습니다.',
      chatRoomLoginRequired: '로그인이 필요합니다.',
      chatRoomNameRequired: '채팅방 이름을 입력해주세요.',
      chatRoomCreateDescription: '새로운 채팅방을 만들어보세요!',
      chatRoomDelete: '채팅방 삭제',
      chatRoomDeleteConfirm: '정말 이 채팅방을 삭제하시겠습니까?',
      chatRoomDeleted: '채팅방이 삭제되었습니다.',
      chatRoomDeleteFailed: '채팅방 삭제에 실패했습니다.',
      chatRoomDeleteError: '채팅방 삭제 중 오류가 발생했습니다.',
      freeChatRooms: '자유채팅방',
      searchChatRooms: '채팅방 검색...',
      back: '뒤로',
      idolMemes: '아이돌 사진 공유',
      newsDetail: '뉴스 상세',
      ...
      events: '이벤트',
      eventsDesc: '포인트 시스템 및 특별 이벤트',
      eventsNew: '새 이벤트',
      eventsNewDesc: '새로운 이벤트 및 활동',
      ...
      category: '카테고리',
      content: '내용',
      questionContentPlaceholder: '질문 내용을 자세히 입력하세요. 이미지를 삽입하려면 위의 \'이미지 삽입\' 버튼을 클릭하세요.',
      insertImage: '이미지 삽입',
      ...
      createPost: '작성하기',
      postCreatedSuccess: '글이 성공적으로 작성되었습니다!',
      postCreateFailed: '글 작성에 실패했습니다.',
      postCreateError: '글 작성 중 오류가 발생했습니다.',
      authRequired: '인증이 필요합니다',
      authRequiredDescription: '게시글 작성을 위해 인증이 필요합니다. 인증센터로 이동하시겠습니까?',
      fullVerificationRequired: '화상통화를 위해서는 인증센터에서 프로필을 완성해주세요. 인증센터로 이동하시겠습니까?',
    ...
    eventTab: {
      ...
      badgeGuide: {
        title: '등급 배지 안내',
        sprout: '씨앗: 75점 미만',
        levels: '🌱 Lv1 75+ / ☘️ Lv2 150+ / 🍀 Lv3 300+ / 🌿 Lv4 600+ / 🌳 Lv5 1200+',
    ...
    tests: {
      ...
      noPosts: '아직 테스트가 없습니다',
      beFirst: '첫 번째 심리테스트를 만들어보세요!',
      participants: '참여자',
      questions: '문제',
      minutes: '분',
      startTest: '테스트 시작',
      startButton: '테스트 시작',
      loading: '테스트를 불러오는 중...',
      errorLoading: '테스트를 불러오는데 실패했습니다.',
      category: '카테고리:',
      ...
      mbti: {
        ...
        questions: {
          ...
          q1b: '소수의 친한 사람들과 깊은 대화를 나눈다',
          q2: '문제를 해결할 때 나는...',
          q2a: '실제 경험과 사실을 바탕으로 접근한다',
          q2b: '새로운 아이디어와 가능성을 탐구한다',
          q3: '중요한 결정을 내릴 때 나는...',
          q3a: '논리적 분석과 객관적 기준을 우선시한다',
          q3b: '개인의 가치와 감정을 중요하게 생각한다',
          q4: '일상 생활에서 나는...',
          q4a: '계획을 세우고 체계적으로 진행한다',
          q4b: '상황에 맞춰 유연하게 대응한다',
          q5: '스트레스를 받을 때 나는...',
          q5a: '다른 사람들과 함께 시간을 보내며 해소한다',
          q5b: '혼자만의 시간을 갖고 재충전한다',
          q6: '새로운 프로젝트를 시작할 때 나는...',
          q6a: '기존의 검증된 방법을 참고한다',
          q6b: '혁신적이고 독창적인 방법을 시도한다',
          q7: '갈등 상황에서 나는...',
          q7a: '객관적 사실과 원칙을 바탕으로 판단한다',
          q7b: '상대방의 감정과 상황을 이해하려 한다',
          q8: '여행을 계획할 때 나는...',
          q8a: '상세한 일정과 예약을 미리 준비한다',
          q8b: '즉흥적이고 자유롭게 즐긴다',
          q9: '회의나 그룹 토론에서 나는...',
          q9a: '적극적으로 발언하고 의견을 제시한다',
          q9b: '다른 사람들의 의견을 듣고 신중히 생각한다',
          q10: '새로운 기술이나 도구를 배울 때 나는...',
          q10a: '단계별로 차근차근 따라하며 배운다',
          q10b: '직접 사용해보며 시행착오를 통해 배운다',
          q11: '친구가 고민을 털어놓을 때 나는...',
          q11a: '논리적 해결책을 제시하려고 노력한다',
          q11b: '공감하고 감정적 지지를 해준다',
          q12: '주말 계획을 세울 때 나는...',
          q12a: '미리 계획을 세우고 실행한다',
          q12b: '그때그때 하고 싶은 것을 한다',
          q13: '새로운 환경에 적응할 때 나는...',
          q13a: '빠르게 적응하고 새로운 사람들과 어울린다',
          q13b: '천천히 관찰하고 적응해나간다',
          q14: '과거 경험을 바탕으로 할 때 나는...',
          q14a: '검증된 방법을 선호한다',
          q14b: '새로운 접근 방식을 시도한다',
          q15: '감정적으로 흔들릴 때 나는...',
          q15a: '논리적으로 상황을 분석한다',
          q15b: '감정을 받아들이고 표현한다',
          q16: '업무나 과제를 처리할 때 나는...',
          q16a: '계획을 세우고 순서대로 진행한다',
          q16b: '유연하게 우선순위를 조정한다',
          q17: '사회적 모임에서 나는...',
          q17a: '많은 사람들과 대화하며 활발하게 참여한다',
          q17b: '소수의 사람들과 깊이 있는 대화를 나눈다',
          q18: '문제 해결 방식에서 나는...',
          q18a: '구체적이고 실용적인 해결책을 찾는다',
          q18b: '창의적이고 혁신적인 아이디어를 제시한다',
          q19: '중요한 결정을 내릴 때 나는...',
          q19a: '객관적 자료와 분석을 중시한다',
          q19b: '개인의 가치관과 감정을 고려한다',
          q20: '일상적인 루틴에서 나는...',
          q20a: '정해진 스케줄을 따르는 것을 선호한다',
          q20b: '유연하고 자유로운 스케줄을 선호한다',
          q21: '에너지를 얻는 방식에서 나는...',
          q21a: '사람들과 함께 있을 때 에너지를 얻는다',
          q21b: '혼자만의 시간을 가질 때 에너지를 얻는다',
          q22: '새로운 정보를 처리할 때 나는...',
          q22a: '구체적이고 명확한 정보를 선호한다',
          q22b: '추상적이고 가능성 있는 정보를 선호한다',
          q23: '갈등을 해결할 때 나는...',
          q23a: '공정하고 논리적인 기준을 적용한다',
          q23b: '상황과 사람을 고려한 유연한 해결책을 찾는다',
          q24: '장기적인 목표를 세울 때 나는...',
      ...
      sampleTests: {
        colorPersonality: {
          title: '색깔로 알아보는 성격 테스트',
          description: '좋아하는 색깔로 나의 진짜 성격을 알아보세요!'
        },
        kpopStyle: {
          title: 'K-POP 스타일 매칭 테스트',
          description: '나와 어울리는 K-POP 아이돌의 패션 스타일은?'
        },
        fortuneDaily: {
          title: '오늘의 운세 테스트',
          description: '오늘 하루 나에게 어떤 일이 일어날까요?'
        },
        memePersonality: {
          title: '밈으로 알아보는 성격 테스트',
          description: '좋아하는 밈으로 나의 성격을 분석해보세요!'
        }
      },
      loveStyle: {
        title: '사랑 스타일 테스트',
    ...
    phoneVerification: {
      ...
      enterCode: '코드를 입력하세요',
      koreanDescription: '카카오톡 또는 SMS 중 선택하세요',
      sending: '발송 중...',
      verifying: '인증 중...',
      codeSent: ' 인증코드가 발송되었습니다',
      verificationCode: '인증코드',
    ...
    profile: {
      ...
      editToComplete: '편집 버튼을 눌러 프로필을 완성해보세요',
      occupation: '직업',
      editProfile: '프로필 편집',
      backToProfile: '뒤로가기',
    ...
    verification: {
      ...
      nickname: '닉네임',
      nicknamePlaceholder: '커뮤니티에서 사용할 닉네임을 입력해주세요',
      nicknameDescription: '커뮤니티 게시글, 댓글 등에서 사용됩니다',
      ...
      languageLevel: '언어 수준',
      interests: '관심사',
      selectedInterests: '선택된 관심사: {count}/5',
      introduction: '자기소개',
      phone: '전화번호',
      university: '대학교',
      studentId: '학번',
  ...
  es: {
    ...
    payments: {
      ...
      // Sistema de Cupones
      coupon20min: 'Sistema de Cupones - 20 min',
      coupon20minDesc: 'Cupón de 20 minutos para videollamadas',
      coupon100min: 'Sistema de Cupones - 100 min',
      coupon100minDesc: 'Cupón de 100 minutos para videollamadas',
      coupon200min: 'Sistema de Cupones - 200 min',
      coupon200minDesc: 'Cupón de 200 minutos para videollamadas',
      coupon400min: 'Sistema de Cupones - 400 min',
      coupon400minDesc: 'Cupón de 400 minutos para videollamadas',
      // VIP Subscription
      ...
      vipLifetime: 'Suscripción Vitalicia VIP',
      vipLifetimeDesc: 'Beneficios Vitalicios VIP',
      // Courses
      course1: 'Curso 1',
      course1Desc: 'Curso integral de cultura y lenguaje coreano básico',
      course2: 'Curso 2',
      course2Desc: 'Curso avanzado para mejorar el nivel de coreano',
      course3: 'Curso 3',
      course3Desc: 'Exploración profunda de la industria K-Pop y cultura del entretenimiento coreano',
      statusPaid: 'Completado',
      statusPending: 'Pendiente',
      minuteCoupon: 'Cupón de minutos',
      koreanCultureBasic: 'Curso básico de cultura coreana',
      // Section Headers
      ...
      selectVip: 'Seleccionar plan VIP',
      selectCourse: 'Seleccionar curso',
      // Payment Success Page
      processingPayment: 'Procesando el pago...',
      pleaseWait: 'Por favor espere',
      paymentFailed: 'Error en el procesamiento del pago',
      paymentFailedDescription: 'Ha fallado el procesamiento del pago. Contacte al administrador o inténtelo de nuevo.',
      tryAgain: 'Intentar de nuevo',
      paymentCompleted: '¡El pago se ha completado!',
      bookingConfirmed: 'La reserva de consulta se ha confirmado exitosamente.',
      paymentInfo: 'Información del pago',
      orderNumber: 'Número de orden:',
      paymentAmount: 'Monto del pago:',
      bookingInfo: 'Información de la reserva',
      bookingProcessing: 'Procesando información de la reserva',
      bookingProcessingDescription: 'Cargando información de la reserva. Se actualizará automáticamente después del procesamiento del webhook.',
      paymentCompletedBadge: 'Pago completado',
      reminderMessage: 'Le enviaremos un recordatorio 1 hora antes del inicio de la consulta.',
      contactMessage: 'Si tiene alguna pregunta sobre la consulta, contáctenos en cualquier momento.',
      paypalNote: '💡 El procesamiento del pago se completó con PayPal.',
      viewBookings: 'Ver lista de reservas',
      backToHome: 'Volver al inicio',
      consultant: 'Consultor:',
      bookingDateTime: 'Fecha y hora de la consulta:',
      bookingDuration: 'Duración de la consulta:',
      bookingTopic: 'Tema de la consulta:',
      reminderNotification: 'Le enviaremos un recordatorio 1 hora antes del inicio de la consulta.',
      contactSupport: 'Si tiene alguna pregunta sobre la consulta, contáctenos en cualquier momento.',
      paypalProcessingComplete: '💡 El procesamiento del pago se completó con PayPal.',
    ...
    auth: {
      ...
      resetPassword: {
        ...
        passwordRequirements: 'No cumple con los requisitos de contraseña',
        resetFailed: 'Falló el restablecimiento de contraseña',
        resetError: 'Ocurrió un error al restablecer la contraseña',
      ...
      loginIdInfo: '💡 Tu ID de inicio de sesión es el correo electrónico o número de teléfono que ingresaste al registrarte',
      password: 'Contraseña',
      ...
      emailLoginIdInfo: 'El correo electrónico se usará como ID de inicio de sesión',
      phone: 'Teléfono',
      phoneLoginIdInfo: 'El número de teléfono se usará como ID de inicio de sesión',
      country: 'País',
      ...
      birthDateHelp: 'Solo las personas mayores de 13 años pueden utilizar Amiko.',
      birthDateRequired: 'Por favor ingresa tu fecha de nacimiento.',
      birthDateInvalid: 'Ingresa una fecha de nacimiento válida.',
      ageRestriction: 'Los menores de 13 años no pueden registrarse sin consentimiento parental.',
      ...
      signUpSuccess: '¡Registro completado exitosamente! Tu ID de inicio de sesión es tu correo electrónico.',
      signUpFailed: 'El registro falló',
      signUpError: 'Ocurrió un error durante el registro',
      alreadyHaveAccount: '¿Ya tienes una cuenta?',
      noAccount: '¿No tienes cuenta?',
      credentialsCheckMessage: 'Por favor verifica tu correo electrónico y contraseña',
      ...
      emailSendFailed: 'Falló el envío de correo electrónico.',
      verificationCodeSendFailed: 'Falló el envío del código de verificación.',
      emailVerificationCodeSendFailed: 'Falló el envío del código de verificación por correo electrónico.',
      smsVerificationCodeSendFailed: 'Falló el envío del código de verificación SMS.',
      whatsappVerificationCodeSendFailed: 'Falló el envío del código de verificación WhatsApp.',
      verificationCodeIncorrect: 'El código de verificación es incorrecto.',
      signUpSuccess: '¡Registro completado! Tu ID de inicio de sesión es tu correo electrónico.',
      signUpError: 'Ocurrió un error durante el registro.',
      emailAlreadyExists: 'Este correo electrónico ya está registrado. Usa otro correo o inicia sesión.',
      phoneAlreadyExists: 'Este número de teléfono ya está registrado. Usa otro número o inicia sesión.',
      checkError: 'Ocurrió un error durante la verificación.',
      systemMaintenance: 'El sistema está en mantenimiento. Inténtalo de nuevo más tarde.',
      loginRequired: 'Se requiere inicio de sesión.',
      titleAndContentRequired: 'Por favor ingresa el título y contenido.',
      announcementCreated: 'El anuncio ha sido creado.',
      announcementCreateFailed: 'Falló la creación del anuncio.',
      imageUploadFailed: 'Falló la subida de imagen.',
      postDeleted: 'La publicación ha sido eliminada.',
      postDeleteFailed: 'Falló la eliminación de la publicación.',
      postDeleteError: 'Ocurrió un error al eliminar la publicación.',
      postCreated: '¡La publicación ha sido creada!',
      postCreateFailed: 'Falló la creación de la publicación.',
      postCreateError: 'Ocurrió un error al crear la publicación.',
      questionCreated: '¡La pregunta ha sido registrada!',
      questionCreateFailed: 'Falló la creación de la pregunta.',
      answerCreated: '¡La respuesta ha sido registrada!',
      answerCreateFailed: 'Falló la creación de la respuesta.',
      profileSaved: '¡Perfil guardado exitosamente!',
      profileSaveFailed: 'Falló el guardado del perfil. Inténtalo de nuevo.',
      linkCopied: '¡El enlace ha sido copiado al portapapeles!',
      pointLimitExceeded: 'Has excedido el límite diario de puntos.',
      imageFileOnly: 'Solo se pueden subir archivos de imagen.',
      fileSizeExceeded: 'El tamaño del archivo excede 5MB.',
      maxImagesExceeded: 'Se pueden subir máximo 5 imágenes.',
      confirmDelete: '¿Realmente quieres eliminar?',
      confirmDeletePost: '¿Realmente quieres eliminar esta publicación?',
      confirmDeleteNews: '¿Realmente quieres eliminar esta noticia?',
    ...
    communityTab: {
      ...
      cleanupFailed: 'Falló la limpieza de historias expiradas.',
      cleanupError: 'Error al limpiar las historias.',
      cleanupSuccess: '{count} historias expiradas han sido eliminadas.',
    ...
    community: {
      ...
      chatRoomSubtitle: 'Amiko Chat - Sala de chat que conecta Corea y América Latina',
      ...
      chatRoomNoRooms: 'Aún no hay salas de chat',
      chatRoomName: 'Nombre de la Sala',
      chatRoomNamePlaceholder: 'Ej: Sala de K-POP',
      chatRoomDescription: 'Descripción',
      chatRoomDescriptionPlaceholder: 'Ingresa una breve descripción de la sala',
      chatRoomThumbnail: 'Imagen de la Sala',
      chatRoomClickToUpload: 'Haz clic para subir imagen',
      chatRoomImageFormat: 'PNG, JPG, GIF (máx 5MB)',
      chatRoomImageOnly: 'Solo se pueden subir archivos de imagen.',
      chatRoomImageSize: 'El tamaño del archivo no puede exceder 5MB.',
      chatRoomUploading: 'Subiendo...',
      chatRoomCancel: 'Cancelar',
      chatRoomCreating: 'Creando...',
      chatRoomCreated: '¡Sala creada exitosamente!',
      chatRoomCreateFailed: 'Error al crear la sala',
      chatRoomCreateError: 'Ocurrió un error al crear la sala',
      chatRoomLoginRequired: 'Se requiere inicio de sesión',
      chatRoomNameRequired: 'Por favor ingresa el nombre de la sala',
      chatRoomCreateDescription: '¡Crea una nueva sala de chat!',
      chatRoomDelete: 'Eliminar Sala',
      chatRoomDeleteConfirm: '¿Realmente deseas eliminar esta sala de chat?',
      chatRoomDeleted: 'Sala eliminada exitosamente.',
      chatRoomDeleteFailed: 'Error al eliminar la sala',
      chatRoomDeleteError: 'Ocurrió un error al eliminar la sala',
      freeChatRooms: 'Salas de Chat Libres',
      searchChatRooms: 'Buscar salas de chat...',
      back: 'Atrás',
      ...
      koreanNewsDescription: '',
      events: 'Eventos',
      eventsDesc: 'Sistema de puntos y eventos especiales',
      eventsNew: 'Eventos Nuevos',
      eventsNewDesc: 'Nuevos eventos y actividades',
      ...
      questionTitlePlaceholder: 'Ingresa el título de la pregunta',
      category: 'Categoría',
      content: 'Contenido',
      questionContentPlaceholder: 'Ingresa el contenido de la pregunta en detalle. Para insertar una imagen, haz clic en el botón \'Insertar Imagen\' de arriba.',
      ...
      categoryKorean: 'Coreano',
      categorySpanish: 'Español',
      writePost: 'Escribir',
      ...
      createPost: 'Crear',
      postCreatedSuccess: '¡La publicación se creó exitosamente!',
      postCreateFailed: 'Error al crear la publicación.',
      postCreateError: 'Ocurrió un error al crear la publicación.',
      authRequired: 'Autenticación requerida',
      authRequiredDescription: 'Se requiere autenticación para crear publicaciones. ¿Deseas ir al centro de autenticación?',
      fullVerificationRequired: 'Para usar videollamadas, completa tu perfil en el centro de autenticación. ¿Deseas ir al centro de autenticación?',
    ...
    eventTab: {
      ...
      badgeGuide: {
        ...
        sprout: 'Semilla: menos de 75 puntos',
        levels: '🌱 Nv1 75+ / ☘️ Nv2 150+ / 🍀 Nv3 300+ / 🌿 Nv4 600+ / 🌳 Nv5 1200+',
        rose: '🌹 Rosa Rosa: 3500+ (elegible para sorteo de billetes cuando haya eventos de boletos de avión en el futuro)',
    ...
    tests: {
      ...
      subtitle: '¡Encantado de verte hoy también!',
      description: '',
      categories: {
        all: 'Todo',
      ...
      noPosts: 'Aún no hay tests',
      beFirst: '¡Crea tu primer test psicológico!',
      participants: 'Participantes',
      questions: 'Preguntas',
      minutes: 'min',
      ...
      yourType: '¡Tu tipo es {mbti}!',
      sameTypeCelebs: 'Celebridades de mi tipo',
      bestMatchType: 'Tipo compatible: {mbti}',
      male: 'Hombre',
      female: 'Mujer',
      ...
      mbti: {
        ...
        questions: {
          ...
          q17a: 'Conversaba activamente con muchas personas',
          q17b: 'Tengo conversaciones profundas con pocas personas',
          q18: 'En mi forma de resolver problemas...',
          q18a: 'Busco soluciones concretas y prácticas',
          q18b: 'Presento ideas creativas e innovadoras',
          q19: 'Al tomar decisiones importantes...',
          q19a: 'Valoro los datos objetivos y el análisis',
          q19b: 'Considero mis valores y emociones personales',
          q20: 'En mis rutinas diarias...',
          q20a: 'Prefiero seguir horarios establecidos',
          q20b: 'Prefiero horarios flexibles y libres',
          q21: 'En cómo obtengo energía...',
          q21a: 'Obtengo energía cuando estoy con personas',
          q21b: 'Obtengo energía cuando tengo tiempo a solas',
          q22: 'Al procesar nueva información...',
      ...
      sampleTests: {
        colorPersonality: {
          ...
          description: '¡Descubre tu verdadera personalidad con tu color favorito!'
        },
        kpopStyle: {
          title: 'Test de Estilo K-POP',
          description: '¿Qué estilo de moda de idols K-POP te queda bien?'
        },
        fortuneDaily: {
          title: 'Test de Fortuna del Día',
          description: '¿Qué te pasará hoy?'
        },
        memePersonality: {
    ...
    profile: {
      ...
      age: 'Edad',
      ageUnit: 'años',
      setupProfile: 'Por favor, configura tu perfil',
      editToComplete: 'Pulsa el botón de editar para completar tu perfil',
      ...
      selfIntroduction: 'Autopresentación',
      interests: 'Intereses',
      interestsWithCount: 'y {count} más',
    ...
    verification: {
      ...
      nickname: 'Apodo',
      nicknamePlaceholder: 'Ingrese un apodo para usar en la comunidad',
      nicknameDescription: 'Se utiliza en publicaciones y comentarios de la comunidad',
      ...
      interests: 'Intereses',
      selectedInterests: 'Intereses seleccionados: {count}/5',
    ...
    phoneVerification: {
      ...
      koreanDescription: 'Selecciona entre KakaoTalk o SMS',
      sending: 'Enviando...',
