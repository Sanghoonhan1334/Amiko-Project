export const translations = {
  ko: {
    ...
    meetTab: {
      ...
      bundleCoupon2: '15분 쿠폰 2장 묶음',
      bundleCoupon3: '15분 쿠폰 3장 묶음',
    ...
    storySettings: {
      ...
      archiveSave: '보관함에 저장',
      basicSettings: '기본 설정',
      autoPublic: '스토리 자동 공개',
      autoPublicDescription: '새로운 스토리를 기본적으로 공개로 설정',
      showInProfile: '프로필에 스토리 표시',
      showInProfileDescription: '다른 사용자가 내 프로필에서 과거 스토리를 볼 수 있음',
      recentStories: '최근 스토리',
      archiveStories: '보관된 스토리',
      hoursAgo: '{hours}시간 전',
      ...
      public: '공개',
      private: '비공개',
      archiveDescription: '보관된 스토리는 영구적으로 저장되며 공개/비공개 설정만 변경할 수 있습니다.',
      noStories: '아직 스토리가 없습니다!',
      noStoriesDescription: '커뮤니티 탭에서 첫 번째 스토리를 올려보세요.',
      goToCommunity: '커뮤니티로 가기',
      storyImage: '스토리 이미지'
    },
  ...
  es: {
    ...
    // 기능 카드 배지
    featureBadges: {
      consultationCoupon: 'Cupón de 15 min',
    ...
    profile: {
      ...
      purchaseItems: {
        consultation15min2: 'Cupón de consulta de 15 min x2'
      },
      edit: 'Editar',
      native: 'Nativo',
      unverified: 'No verificado',
    ...
    storySettings: {
      ...
      archiveSave: 'Guardar en Archivo',
      basicSettings: 'Configuración Básica',
      autoPublic: 'Publicar Historias Automáticamente',
      autoPublicDescription: 'Configurar las historias nuevas como públicas por defecto',
      showInProfile: 'Mostrar Historias en Perfil',
      showInProfileDescription: 'Otros usuarios pueden ver historias pasadas en mi perfil',
      recentStories: 'Historias Recientes',
      archiveStories: 'Historias Archivadas',
      hoursAgo: 'Hace {hours} horas',
      makePrivate: 'Hacer Privada',
      makePublic: 'Hacer Pública',
      delete: 'Eliminar',
      deleteConfirm: '¿Estás seguro de que quieres eliminar esta historia?',
      archive: 'Archivo',
      written: 'Escrito',
      public: 'Público',
      private: 'Privado',
      archiveDescription: 'Las historias archivadas se almacenan permanentemente y solo se puede cambiar la configuración de público/privado.',
      noStories: '¡Aún no hay historias!',
      noStoriesDescription: 'Sube tu primera historia en la pestaña Comunidad.',
