              ...
              <div className="flex items-center justify-between min-h-[600px] py-20">
                ...
                <div className="flex-1 max-w-2xl">
                  <div className="inline-flex items-center gap-2 bg-green-100/50 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-green-200/30">
                    ...
                    <span className="text-green-700 font-medium text-sm">실시간 AI 통역 서비스</span>
                  </div>
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed mb-6">
                    실시간 AI 통역을 통해 언어의 장벽 없이 자유롭게 대화할 수 있습니다. 한국어와 스페인어 간의 자연스러운 번역으로 진정한 소통을 경험하세요.
                  </p>
                  
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-gray-700">실시간 음성 번역</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-gray-700">텍스트 채팅 번역</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-gray-700">문화적 맥락 이해</span>
                    </div>
                  </div>
                  
                  <Button 
                    onClick={() => router.push('/main?tab=meet')}
                    className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                    대화 시작하기
                  </Button>
                </div>
              ...
              <div className="flex items-center justify-between min-h-[600px] py-20">
                ...
                <div className="flex-1 max-w-2xl">
                  <div className="inline-flex items-center gap-2 bg-purple-100/50 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-purple-200/30">
                    ...
                    <span className="text-purple-700 font-medium text-sm">검증된 한국인 튜터들과 함께</span>
                  </div>
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed mb-6">
                    검증된 한국인 튜터들이 여러분들과 함께합니다. 서로의 나라에 대한 좋은 이미지를 가지고 그들을 만나기 위해 화상 채팅 어플을 사용했던 경험이 있으신가요?
                  </p>
                  ...
                  <Button 
                    ...
                    className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                    커뮤니티 참여하기
                  </Button>
                </div>
                ...
                {/* 오른쪽 이미지 영역 */}
                <div className="flex-1 flex justify-center items-center">
                  <div className="w-80 h-80 bg-gradient-to-br from-purple-100 to-violet-100 rounded-full flex items-center justify-center shadow-2xl">
                    <div className="text-6xl">👥</div>
                  </div>
                </div>
              </div>
