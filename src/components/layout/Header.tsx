                  ...
                  <div className="flex items-center gap-2">
                    {verificationStatus === 'loading' ? (
                      ...
                      <div className="flex items-center gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-gradient-to-r from-emerald-50 to-green-50 rounded-full border border-emerald-200 shadow-sm">
                        ...
                        <span className="text-sm text-emerald-700 font-medium whitespace-nowrap lg:whitespace-normal lg:break-words">
                          <span className="lg:hidden">{t('myTab.verificationComplete')}</span>
                          <span className="hidden lg:inline">Verificación<br/>completada</span>
                        </span>
                      </div>
                    ) : (
