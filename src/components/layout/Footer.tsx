    ...
    <footer className="bg-gradient-to-br from-brand-50 via-mint-50 to-yellow-50 border-t border-brand-200/50">
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
          {/* 왼쪽: 저작권 및 정책 */}
          <div className="space-y-2 sm:space-y-3 mx-auto max-w-fit ml-auto mr-4">
            <div className="text-gray-700 text-xs sm:text-sm font-['Inter'] font-medium">
          ...
          {/* 가운데: 고객지원 */}
          <div className="space-y-2 sm:space-y-3 mx-auto max-w-fit">
            <h4 className="font-bold text-gray-800 text-base sm:text-lg font-['Inter']">{t('footer.support')}</h4>
            <div className="space-y-1 sm:space-y-2">
              <Link 
                href="/help" 
                className="block text-gray-700 hover:text-mint-600 transition-colors duration-300 text-xs sm:text-sm font-['Inter'] font-medium"
              >
                {t('footer.help')}
              </Link>
              <Link 
          ...
          <div className="space-y-2 sm:space-y-3">
            <h5 className="text-base sm:text-lg font-bold text-gray-800 font-['Inter']">{t('footer.officialSns')}</h5>
            <div className="flex items-center gap-2 sm:gap-4">
              {/* TikTok */}
              <Button
                variant="ghost"
                size="lg"
                className="w-12 h-12 sm:w-16 sm:h-16 p-0 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl bg-white"
        ...
        {/* 추가 정보 */}
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-brand-200/30">
