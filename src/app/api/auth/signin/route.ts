  ...
  try {
    ...
    return NextResponse.json({
      ...
      user: {
        ...
        country: user.user_metadata?.country || profile?.country,
        is_korean: user.user_metadata?.is_korean || profile?.is_korean,
        avatar_url: profile?.avatar_url,
        bio: profile?.bio,
        native_language: profile?.native_language,
        kakao_linked_at: profile?.kakao_linked_at,
        wa_verified_at: profile?.wa_verified_at,
        sms_verified_at: profile?.sms_verified_at,
