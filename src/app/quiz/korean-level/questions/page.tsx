...
export default function KoreanLevelQuestionsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-blue-100 pt-28 sm:pt-32 md:pt-40">
      {/* 헤더 */}
      <div className="bg-white/80 backdrop-blur-sm shadow-lg">
        <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-4">
          <div className="flex items-center justify-between gap-2 sm:gap-0">
            ...
            {/* 진행률 표시 */}
            <div className="flex-1 max-w-[120px] sm:max-w-xs ml-2 sm:ml-8">
              <div className="flex items-center justify-between text-[10px] sm:text-sm text-gray-600 mb-1">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        <div className="max-w-2xl mx-auto">
          {/* 질문 카드 */}
          <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-8 mb-4 sm:mb-8">
            {/* 난이도 표시 */}
            ...
            <div className="mb-4 sm:mb-8">
              <h2 className="text-base sm:text-2xl font-bold text-gray-800 mb-2 sm:mb-4 leading-relaxed">
              ...
              {currentQuestion.options.map((option, index) => (
                ...
                >
                  <div className="flex items-center">
                    <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-3 sm:mr-4 font-bold text-xs sm:text-base ${
                      selectedAnswer === index
